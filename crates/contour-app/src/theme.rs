//! Modern dark theme for Contour.
//!
//! Matches the Prism suite look established by Pigment: rounded widgets, a teal
//! accent, layered panel backgrounds, and comfortable spacing. Reimplemented
//! here (not shared) so Contour can drift its palette independently later.
//! Call [`apply`] once at startup with `cc.egui_ctx`.
...
/// Apply Contour's modern dark theme to the given egui context.
...
/// The teal accent, exposed for selection highlights on the canvas.
