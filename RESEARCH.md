...
infrastructure decisions live in [../SUITE.md](../SUITE.md) and mirror [Pigment's research](../pigment/RESEARCH.md).
...
every AI tool degrades gracefully when models/GPU are absent. (Details: [../pigment/RESEARCH.md §10](../pigment/RESEARCH.md).)
