...
- [~] **Symbols & global swatches in the UI** (M) — a Swatches panel and a Symbols panel (instances + edit-master). *(Swatches panel **done** — see §5 Color system: build/apply/global-edit/eyedropper all ship. **Still open:** the Symbols panel (instances + edit-master).)*
